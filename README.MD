...
* Since the database comes with debug data but not with manual testing data, create a user using an API call. You can use Postman or a similar tool to send a POST request to the API.
